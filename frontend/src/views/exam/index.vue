    ...
    <el-row :gutter="24">
      ...
      <el-col :span="19" :xs="24">
        <el-card class="qu-content content-h">
          ...
          <!-- 多选题区域 -->
          <div v-if="quData.quType === 2 || quData.quType === 4">
  ...
  methods: {
    ...
    handSave(item, callback) {
      ...
      if (false && currentQuType === 4) {
        ...
        if (currentQuType === 2 || currentQuType === 4) { // 多选
      ...
      const params = {
       ...
       // 对多选题答案进行排序 (如果需要)
       if ((currentQuType === 2 || currentQuType === 4) && hasAnswer) {
    ...
    submitLastAnswer() {
      ...
      if (false && currentQuType === 4) {
        ...
        // 单选、多选、判断题答案
        const answers = []
        if (currentQuType === 2 || currentQuType === 4) {
          answers.push(...this.multiValue)
    ...
    fetchQuData(item) {
      ...
      quDetail(params).then((response) => {
        ...
        if (false && response.data.quType === 4) {
        ...
        } else if (response.data.quType === 2 || response.data.quType === 4) {
