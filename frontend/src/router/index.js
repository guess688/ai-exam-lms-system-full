...
export const constantRoutes = [
  ...
  },
  {
    ...
    children: [{
      ...
      meta: { title: '课程管理', visible: true, roles: ['teacher', 'admin'], icon: 'el-icon-reading' }
    }]
  },
  {
    ...
    children: [{
      ...
      meta: { title: '章节管理', visible: true, roles: ['teacher', 'admin'], icon: 'el-icon-notebook-2' }
    }]
  },
  {
    path: '/course-video-management',
    component: Layout,
    children: [{
      path: '/course-video-management',
      name: 'course-video-management',
      component: () => import('@/views/course/video'),
      meta: { title: '网课管理', visible: true, roles: ['teacher', 'admin'], icon: 'el-icon-video-camera' }
    }]
  },
  {
    ...
    children: [{
      ...
      meta: { title: '知识点管理', visible: true, roles: ['teacher', 'admin'], icon: 'el-icon-collection-tag' }
    }]
  },
  {
    path: '/my-courses',
    ...
    children: [{
      ...
      meta: { title: '我的课程', visible: true, roles: ['student'], icon: 'el-icon-reading' }
    }]
  },
  {
    path: '/old-course-detail',
    component: Layout,
    children: [{
      path: '/old-course-detail',
      name: 'old-course-detail',
      hidden: true,
      component: () => import('@/views/course/detail'),
      meta: { title: '课程详情旧版', visible: true, roles: ['teacher', 'admin', 'student'], icon: 'dashboard' }
    }]
  },
  {
    path: '/course-detail',
    ...
    children: [{
      ...
      name: 'course-detail',
      hidden: true,
      component: () => import('@/views/course/detail-v2'),
      meta: { title: '课程详情', visible: true, roles: ['teacher', 'admin', 'student'], icon: 'dashboard' }
    }]
  },
  {
    path: '/learning-task-management',
    component: Layout,
    children: [{
      path: '/learning-task-management',
      name: 'learning-task-management',
      component: () => import('@/views/task/manage'),
      meta: { title: '学习任务', visible: true, roles: ['teacher', 'admin'], icon: 'el-icon-date' }
    }]
  },
  {
    path: '/my-learning-tasks',
    component: Layout,
    children: [{
      path: '/my-learning-tasks',
      name: 'my-learning-tasks',
      component: () => import('@/views/task/my'),
      meta: { title: '我的任务', visible: true, roles: ['student'], icon: 'el-icon-date' }
    }]
  },
  {
    path: '/learning-behavior-management',
    component: Layout,
    children: [{
      path: '/learning-behavior-management',
      name: 'learning-behavior-management',
      component: () => import('@/views/behavior/manage'),
      meta: { title: '学习行为评价', visible: true, roles: ['teacher', 'admin'], icon: 'el-icon-data-analysis' }
    }]
  },
  {
    path: '/my-learning-behavior',
    component: Layout,
    children: [{
      path: '/my-learning-behavior',
      name: 'my-learning-behavior',
      component: () => import('@/views/behavior/my'),
      meta: { title: '我的学习评价', visible: true, roles: ['student'], icon: 'el-icon-data-analysis' }
    }]
  },
  {
...
},
{
  ...
  },
  {
    ...
    children: [{
      ...
      component: () => import('@/views/question/ai'),
      meta: { title: 'AI 出题审核', visible: true, roles: ['teacher', 'admin'], icon: 'el-icon-magic-stick' }
    }]
  },
  {
    path: '/questions-add',
