...
public interface IExamService extends IService<Exam> {
    ...
    /**
     * Auto generate exam by course, chapter, knowledge point, type and difficulty.
     *
     * @param form auto generation request
     * @return generated exam id
     */
    Result<Integer> autoGenerateExam(ExamAutoGenerateForm form);
