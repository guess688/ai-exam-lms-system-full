...
public class QuestionFrom {
    ...
    @NotNull(message = "课程id(courseId)不能为空", groups = QuestionGroup.QuestionAddGroup.class)
    private Integer courseId;

    @NotNull(message = "章节id(chapterId)不能为空", groups = QuestionGroup.QuestionAddGroup.class)
    private Integer chapterId;

    @NotNull(message = "知识点id(knowledgePointId)不能为空", groups = QuestionGroup.QuestionAddGroup.class)
    private Integer knowledgePointId;

    @NotBlank(message = "难度(difficulty)不能为空", groups = QuestionGroup.QuestionAddGroup.class)
